        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MustModuleId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Studyroutes",
                columns: new[] { "Id", "HistoricalRoute", "Name", "StudentId" },
                values: new object[,]
                {
                    { 1, false, "Studieroute1", 1234 },
                    { 2, true, "Studieroute2", 1234 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ModuleId", "SchoolYearId", "Semester", "StudyrouteId" },
                values: new object[,]
                {
                    { 1, 1, 1, 1, 1 },
                    { 2, 2, 1, 1, 1 }
